...
CREATE TABLE `llamados` (
  ...
  `hora_respondida` datetime DEFAULT NULL,
  ...
  CONSTRAINT `llamados_ibfk_1` FOREIGN KEY (`lugar`) REFERENCES `lugar` (`id`),
  CONSTRAINT `llamados_ibfk_2` FOREIGN KEY (`medico`) REFERENCES `medico` (`id`),
  CONSTRAINT `llamados_ibfk_3` FOREIGN KEY (`paciente`) REFERENCES `paciente` (`id`)
...
-- Dump completed on 2022-11-16 12:33:16
